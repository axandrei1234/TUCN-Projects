...
public:
    virtual void mesaj() {
        cout << "Mesaj din clasa Vehicul" << endl;
    }
    virtual void set(int) {cout << "" << endl;}
    virtual int get() {cout << "" << endl; return 1;}
};

class Automobil : public Vehicul {
    int incarcatura_pasageri;
public:
    void set(int incarcatura_pasageri) override {this->incarcatura_pasageri = incarcatura_pasageri;}
    int get() override {return incarcatura_pasageri;}
    void mesaj() override {
...
public:
    ...
    void mesaj() override {
        cout << "Mesaj din clasa Barca" << endl;
    }
};
